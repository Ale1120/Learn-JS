...
class Games {
  ...
  toggleButtonStar(){
    if(buttonStar.classList.contains('hide')){
      buttonStar.classList.remove('hide')
    }
    else {
  ...
  wine() {
    swal('Platzi','Congratulations, You Won The Game!', 'success')
    .then (this.initialize)
  }

  gameOver() {
    swal('Platzi','I am Sorry, You Lost', 'error')
    .then ( ()=> {
      this.deleteClick()
      this.initialize()
    })
